...
export declare class NgxDocScannerComponent implements OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NgxDocScannerComponent, "ngx-doc-scanner", never, { "file": "file"; "config": "config"; }, { "exitEditor": "exitEditor"; "editResult": "editResult"; "error": "error"; "ready": "ready"; "processing": "processing"; }, never, never, false>;
}
/**
